...
interface ProductPickerProps {
  ...
  onCancel: () => void;
  /** When set, only show results for this store. */
  store?: 'kroger' | 'amazon';
}

export function ProductPicker({ itemId, itemName, kroger, onConfirm, onCancel, store }: ProductPickerProps) {
